...
public class App {
    ...
    private static void crearTarjetasRegalo() {
        ...
        try {
            ...
            TarjetaRegalo tarjetaRegalo3 = TarjetaRegalo.fusionar(tarjetaRegalo1, tarjetaRegalo2);
            //tarjetaRegalo3 = TarjetaRegalo.fusionar(tarjetaRegalo1, tarjetaRegalo2);
            System.out.println(tarjetaRegalo3);
            System.out.println(tarjetaRegalo1); // compruebo que las tarjetas fusionadas no tienen saldo
            System.out.println(tarjetaRegalo2);
